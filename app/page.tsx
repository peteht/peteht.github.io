      ...
      <main className={styles.homeWrap}>
        <article className={styles.home}>
          <p className={styles.bio}>
            Hi I'm Pete, a senior front-end engineer with 15 years of experience
            building polished, high-performance web applications across
            government, gaming, enterprise, and agency environments. I own
            features end to end, move fast across tech stacks, and pick up new
            domains quickly. My toolkit includes JavaScript, TypeScript, React,
            Next.js, Vue, Node.js, and React Native, plus the full range of
            front-end primitives: WebSockets, REST APIs, CSS, SVG, Canvas, and
            animation.
          </p>
          <p className={styles.bio}>
